...
import { wrapperRouter } from '../../test/test-utils'
import { LOG_IN, LOG_OUT, PROFILE } from '../../utils/constants'
import MangAnimeppBar from '../header/MangAnimeAppBar'
...
describe('first', () => {
  ...
  test('Quand on clique sur le logo navigate est appelé', async () => {
    render(<MangAnimeppBar />, { wrapper: wrapperRouter })
  ...
  test.todo(`Quand on clique sur le logo lorsqu'on est pas à l'accueil, navigate est pas appelé avec la route '${ROUTE_HOME}'`)
